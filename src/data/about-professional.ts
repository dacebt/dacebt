...
export const professionalAboutTopics: AboutTopic[] = [
  {
    id: "career",
    label: "Career",
    messages: [
  ...
  },
  {
    ...
    messages: [
      ...
      {
        message:
          "I mean I'm a Senior Full Stack Developer—comfortable using any technology to get the job done. JavaScript, TypeScript, Python, Go, Solidity, backend or frontend—you name it, I'll figure it out.",
        speaker: "David",
        image: "/images/avatar.png",
      },
      {
