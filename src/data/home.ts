...
export const welcomeMessages: DialogueMessage[] = [
  ...
  {
    message: "Please navigate to the projects page to see my work, or check out the contact page to get in touch, or peek the about page to learn a little more about me!",
    speaker: "David",
    image: "/images/avatar.png",
  },
]
